...
void main()
{
    ...
    // // Pattern 13
    // float strength = step(0.4, mod(v_uv.x * 10.0, 1.0));
    // strength *= step(0.8, mod(v_uv.y * 10.0, 1.0));

    // // Pattern 14
    // float barX = step(0.4, mod(v_uv.x * 10.0, 1.0)) * step(0.8, mod(v_uv.y * 10.0, 1.0));
    // float barY = step(0.8, mod(v_uv.x * 10.0, 1.0)) * step(0.4, mod(v_uv.y * 10.0, 1.0));
    // float strength = barX + barY;
    // strength = clamp(strength, 0.0, 1.0);

    // // Pattern 15
    // float barX = step(0.4, mod(v_uv.x * 10.0 - 0.2, 1.0)) * step(0.8, mod(v_uv.y * 10.0, 1.0));
    // float barY = step(0.8, mod(v_uv.x * 10.0, 1.0)) * step(0.4, mod(v_uv.y * 10.0 - 0.2, 1.0));
    // float strength = barX + barY;
    // strength = clamp(strength, 0.0, 1.0);
    ...
    // // Pattern 20
    // float strength = step(0.2, max(abs(v_uv.x - 0.5), abs(v_uv.y - 0.5)));
    // strength *= 1.0 - step(0.25, max(abs(v_uv.x - 0.5), abs(v_uv.y - 0.5)));
    ...
    // // Pattern 24
    // vec2 gridUv = vec2(floor(v_uv.x * 10.0) / 10.0, floor(v_uv.y * 10.0) / 10.0);
    // float strength = random(gridUv);

    // // Pattern 25
    // vec2 gridUv = vec2(floor(v_uv.x * 10.0) / 10.0, floor((v_uv.y + v_uv.x * 0.5) * 10.0) / 10.0);
    // float strength = random(gridUv);
    ...
    // // Pattern 30
    // float strength = 0.15 / (distance(vec2(v_uv.x, (v_uv.y - 0.5) * 5.0 + 0.5), vec2(0.5)));

    // // Pattern 31
    // float strength = 0.15 / (distance(vec2(v_uv.x, (v_uv.y - 0.5) * 5.0 + 0.5), vec2(0.5)));
    // strength *= 0.15 / (distance(vec2(v_uv.y, (v_uv.x - 0.5) * 5.0 + 0.5), vec2(0.5)));
    ...
    // // Pattern 35
    // float strength = step(0.01, abs(distance(v_uv, vec2(0.5)) - 0.25));
    ...
    // // Pattern 42
    // float angle = atan(v_uv.x - 0.5, v_uv.y - 0.5) / (PI * 2.0) + 0.5;
    // float strength = angle;
    ...
    // // Pattern 49
    // float strength = sin(cnoise(v_uv * 10.0) * 20.0);
