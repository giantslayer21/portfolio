...
, function(t, e, n) {
    ...
    i = function() {
        function t(t) {
            this.id = null != t ? t : "",
            this.resizeSearchPanel = o(this.resizeSearchPanel, this),
        ...
        t.prototype.initThumbsInteraction = function(t, e, n) {
            ...
            null == e && (e = 10),
            null == n && (n = 10),
            utils.isDesktop && (i = this,
            this.thumbs = [],
            this.$contentsInner.find(t).each(function(t, o) {
                var s;
                return s = new r($(this),e,n),
                i.thumbs.push(s),
                s.init()
            }))
        }
        ...
        t.prototype.initSearchPanel = function(t) {
            ...
            e = this.$keyword.find("input"),
            this.$keyword.find(".btnSubmit").on("click", function(n) {
                return function(n) {
                    return tkmh.searchByKeyword(t, "?s=" + e.val()),
                    !1
                }
            }(this)),
            n = function(t) {
                return function(t, e, n) {
                    return null == n && (n = !0),
                    n ? (t.toggleClass("closed"),
                    e.toggleClass("closed")) : (t.addClass("closed"),
                    e.addClass("closed"))
                }
            }(this),
            this.$btnCategories = this.$searchPanel.find(".btnCategories").on("click", function(t) {
                return function(e) {
                    return n(t.$btnCategories, t.$categories),
                    n(t.$btnTags, t.$tags, !1),
                    n(t.$btnMonthlyArchives, t.$monthlyArchives, !1),
                    n(t.$btnKeyword, t.$keyword, !1),
                    !1
                }
            }(this)),
            this.$btnTags = this.$searchPanel.find(".btnTags").on("click", function(t) {
                return function(e) {
                    return n(t.$btnCategories, t.$categories, !1),
                    n(t.$btnTags, t.$tags),
                    n(t.$btnMonthlyArchives, t.$monthlyArchives, !1),
                    n(t.$btnKeyword, t.$keyword, !1),
                    !1
            ...
            this.$btnMonthlyArchives = this.$searchPanel.find(".btnMonthlyArchives").on("click", function(t) {
                return function(e) {
                    return n(t.$btnCategories, t.$categories, !1),
                    n(t.$btnTags, t.$tags, !1),
                    n(t.$btnMonthlyArchives, t.$monthlyArchives),
                    n(t.$btnKeyword, t.$keyword, !1),
                    !1
                }
            }(this)),
            this.$btnKeyword = this.$searchPanel.find(".btnKeyword").on("click", function(t) {
                return function(e) {
                    return n(t.$btnCategories, t.$categories, !1),
                    n(t.$btnTags, t.$tags, !1),
                    n(t.$btnMonthlyArchives, t.$monthlyArchives, !1),
                    n(t.$btnKeyword, t.$keyword),
                    !1
                }
            }(this))
        }
...
, function(t, e, n) {
    ...
    i = function() {
        function t(t, e, n) {
            this.$container = t,
            this.widthSegments = null != e ? e : 20,
            this.heightSegments = null != n ? n : 10,
        ...
        t.prototype.init = function(t) {
            Detector.webgl ? this.initWebGL(t) : (log("not supported"),
            "function" == typeof t && t())
        }
        ,
        t.prototype.initWebGL = function(t) {
            var i, r, o, s, a, h, u, c;
            for (this.isWebGLSupported = !0,
            ...
            this.renderer.setPixelRatio(u),
            this.scene = new THREE.Scene,
            this.camera = new THREE.PerspectiveCamera(45,this.width / this.height,1,1e3),
            this.camera.position.set(0, 0, 1),
            this.scene.add(this.camera),
            h = (this.widthSegments + 1) * (this.heightSegments + 1),
            a = [],
            r = s = 0,
            c = h; 0 <= c ? s < c : s > c; r = 0 <= c ? ++s : --s)
                a.push(utils.map(Math.random(), 0, 1, -1, 1, !0));
            this.geometry = new THREE.PlaneBufferGeometry(e,e,this.widthSegments,this.heightSegments),
            this.geometry.addAttribute("vertexIndex", new THREE.BufferAttribute(new Uint16Array(_.range(h)),1)),
            this.geometry.addAttribute("noiseValue", new THREE.BufferAttribute(new Float32Array(a),1)),
            a = null,
            ...
            i = this.$container.find("img"),
            o = i.attr("src"),
            this.material.uniforms.texture.value = (new THREE.TextureLoader).load(o, function(t) {
                return function(e) {
                    return t.resize(),
                    t.draw(),
                    i.remove(),
                    i = null,
                    t.$container.find(".detail").remove()
                }
            }(this)),
            this.$container.on({
        ...
        t.prototype.resize = function() {
            ...
            t = -(this.height / 2) / Math.tan(this.camera.fov * Math.PI / 180 / 2),
